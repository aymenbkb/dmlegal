...
const translations = {
  ...
  en: {
    ...
    'footer-email': 'Email: contact@dmlegal.com',
    ...
    'uae-description': 'The UAE is a constitutional federation of seven emirates that was established on December 02nd, 1971. At the crossroad between West and East, the UAE is a politically and economically stable country and holds the 25th position globally in the <strong>Global Competitiveness Report 2019</strong> by the <strong>World Economic Forum</strong>, at the heart of exchanges and business relations. Recognized as a tolerant country, the UAE hosts more than 200 nationalities doing business, living, learning, and touring the UAE based on the vision of its First President, the late H.Sheikh Zayed bin Sultan Al Nahyan, who created a unique model of society and coexistence. At <strong>DM Legal</strong>, we embrace the same vision and values, and therefore, our team is eager to assist and advise our clients based on those principles.',

    'who-we-are-label': 'WHO WE ARE',
    'about-heading': 'About <strong>DM Legal</strong>',
    'about-desc': '<strong>DM Legal</strong> is a global law firm, with offices covering US, Europe and Middle East.<br>The world goes global, so are we.<br>The Founding Partners Jordana Dray and Andrew Mitchell KC are experienced international practitioners with a large regionally interconnected cases track record, with a very diversified worldwide network of correspondents and experts.',
    ...
    'service5': 'Tax Law',
    'service5-description': 'At <strong>DM Legal</strong>, we provide expert guidance on VAT registration, corporate tax, tax compliance, and cross-border tax issues.',
    'service6': 'Wills &amp; Estate Planning',
    'service6-description': '<strong>DIFC</strong> and <strong>ADGM</strong> Wills provide a secure mechanism for non-Muslim expatriates to distribute their assets according to their wishes.',
    ...
    'service2-item2': '<strong>Trademarks:</strong> Registration and protection of brand names, logos, and symbols that distinguish goods or services.',
    'service2-item3': '<strong>Copyrights:</strong> Safeguarding original creative works such as art, music, literature, and software.',
    'service2-item4': '<strong>Trade Secrets:</strong> Ensuring confidentiality of proprietary business information and processes.',
    'service2-item5': '<strong>IP Enforcement:</strong> Legal actions to prevent infringement and unauthorized use of IP assets.',
    ...
    'service3-content': 'At <strong>DM Legal</strong>, we specialize in criminal law with international scope, offering expert defense strategies and legal advice across multiple jurisdictions. All procedures are handled in collaboration with local attorneys representing clients in front of national courts and international tribunals (<strong>ECHR</strong>, <strong>ICC the Hague</strong>, Interpol, and other supranational bodies).',
    ...
    'service4-item2': '<strong>Residency and Citizenship:</strong> Guidance on obtaining permanent residency or citizenship.',
    'service4-item3': '<strong>Work Permits:</strong> Securing legal authorization for employment in a foreign country.',
    'service4-item4': '<strong>Immigration Compliance:</strong> Ensuring adherence to immigration laws and avoiding penalties.',
    'service4-item5': '<strong>Temporary Relocation:</strong> Facilitating short-term stays for business or personal purposes.',
    ...
    'service5-description': 'At <strong>DM Legal</strong>, we provide expert guidance on all aspects of tax law to help businesses navigate the complexities of VAT registration, corporate tax registration, tax compliance, and cross-border tax issues.',
    ...
    'service5-item7': '<strong>UAE Corporate Tax:</strong> Assisting individuals and companies in understanding the implementation of UAE Corporate Tax and minimising risk exposure in UAE and abroad.',
    'service5-item2': '<strong>Tax Compliance:</strong> Ensuring that businesses adhere to tax laws and regulations, minimizing the risk of penalties.',
    'service5-item3': '<strong>Income Tax Returns:</strong> Providing support in filing and managing income tax returns for businesses and individuals.',
    'service5-item4': '<strong>Cross-Border Taxation:</strong> Offering guidance on international tax issues, including tax treaties and transfer pricing.',
    'service5-item5': '<strong>Tax Disputes and Litigation:</strong> Representing clients in disputes with tax authorities and resolving complex tax issues.',
    ...
    'service6-item2': '<strong>Inheritance Laws:</strong> Understanding how assets are passed to heirs in accordance with UAE laws.',
    'service6-item3': '<strong>Guardianship for Minors:</strong> Specifying guardianship arrangements for your children in case of your passing.',
    'service6-item4': '<strong>Dispute Resolution:</strong> Offering assistance with potential family disagreements regarding the inheritance of assets.',
    ...
    'service7-part4-title': '<strong>UK</strong> Courts',
    'service7-part4-desc': 'Founded on the principles of English common law, the <strong>UK courts</strong> are characterised by the doctrine of judicial precedent and adversarial proceedings. The system comprises a hierarchical structure, including the High Court of Justice, Court of Appeal, and the Supreme Court of the United Kingdom. Renowned for their global influence, UK courts play a central role in resolving complex civil and commercial disputes, including cross-border matters.',
    'service7-part5-title': '<strong>Caribbean</strong> Jurisdictions',
    'service7-part5-desc': 'Operating within common law frameworks largely derived from the English legal system, <strong>Caribbean and offshore courts</strong> serve as key jurisdictions for international dispute resolution and corporate matters. This includes courts in Cayman Islands, British Virgin Islands, Turks and Caicos Islands, Grenada, Trinidad and Tobago, and Antigua and Barbuda. These jurisdictions are widely recognised for their role in handling complex commercial disputes, offshore structures, and multi-jurisdictional legal matters.',
    'service7-description': '<strong>DM Legal</strong>\'s team is always supportive of alternative dispute resolutions solutions and settlements but with registered practitioners in the local Common Law Courts, the team is happy to represent its clients in front of:',
    'service7-key': 'Key Areas of This Service Include:',
    'service7-item1': '<strong>Arbitration Expertise:</strong> Our team of experienced and bilingual lawyers specializes in arbitration procedures and proceedings both within and outside UAE.',
    ...
    'service8-description': '<strong>Family Law</strong> governs legal matters related to family, including but not limited to marriage, divorce, child custody, alimony, and inheritance. The UAE legal framework is primarily influenced by both civil law and Sharia principles, with distinct provisions for Muslims and non-Muslims.',
    'service8-key': 'Key Areas of Family Law Include:',
    'service8-item1': '<strong>Divorce Proceedings:</strong> Legal processes for dissolving marriages and resolving related disputes.',
    'service8-item2': '<strong>Child Custody and Visitation:</strong> Determining parenting arrangements and visitation rights.',
    'service8-item3': '<strong>Alimony and Financial Support:</strong> Establishing financial support for spouses and dependents.',
    ...
    'service9-item3_co': '<strong>Shareholders\' Rights:</strong> Protecting and enforcing the rights of minority and majority shareholders.',
    'service9-item4_co': '<strong>Restructuring:</strong> Legal support for company restructuring, mergers, demergers, and corporate reorganizations.',
    ...
    'service10-item2': '<strong>Sales of Goods:</strong> Laws governing the buying and selling of goods and services.',
    'service10-item3': '<strong>Agency:</strong> Legal relationships where one party acts on behalf of another.',
    'service10-item4': '<strong>Banking and Finance:</strong> Regulations for financial transactions and institutions.',
    ...
    'team1-item3': 'Top-ranked in <strong>Chambers UK Bar</strong> and <strong>Legal 500</strong>.',
    ...
    'member1-bar-admissions': 'Bar Admissions: England &amp; Wales (Barrister &amp; King\'s Counsel); Cayman Islands; Jamaica; Grenada; British Virgin Islands; Turks and Caicos Islands; Caribbean Jurisdictions',
    ...
    'team2-item4': '<strong>ICC</strong> (International Criminal Court in The Hague) listed counsel.',
    'team2-item5': 'French Courts (CFI, Court of Appeal, Commercial Court, Criminal Courts in Paris and across France).',
    'team2-item6': 'DIAC (UAE) - Dubai International Arbitration Centre.',
    'team2-item8': 'ICC - International Chamber of Commerce.',
    'team2-item9': 'Arbitration &amp; Dispute Resolution.',
  ...
  fr: {
    ...
    'footer-email': 'E-mail : contact@dmlegal.com',
    ...
    'uae-description': 'Les EAU sont une fédération constitutionnelle de sept émirats créée le 2 décembre 1971. Carrefour entre l\'Occident et l\'Orient, les EAU sont un pays politiquement et économiquement stable qui occupe la 25e place mondiale dans le <strong>Rapport sur la compétitivité mondiale 2019</strong> du <strong>Forum économique mondial</strong>, au cœur des échanges et des relations commerciales. Reconnus comme un pays tolérant, les EAU accueillent plus de 200 nationalités qui y font des affaires, y vivent, y apprennent et y voyagent, selon la vision de son premier président, feu S.A. Sheikh Zayed bin Sultan Al Nahyan, qui a créé un modèle unique de société et de coexistence. Chez <strong>DM Legal</strong>, nous partageons cette même vision et ces mêmes valeurs, et notre équipe s\'engage à accompagner et conseiller nos clients selon ces principes.',

    'who-we-are-label': 'QUI SOMMES-NOUS',
    'about-heading': 'À propos de <strong>DM Legal</strong>',
    'about-desc': '<strong>DM Legal</strong> est un cabinet d\'avocats international, présent aux États-Unis, en Europe et au Moyen-Orient.<br>Le monde n\'a plus de frontières, nous non plus.<br>Les associés fondateurs, Jordana Dray et Andrew Mitchell KC, sont des avocats dotés d\'une solide expérience à l\'international. Ils disposent d\'une large maîtrise des dossiers complexes à forte dimension régionale, s\'appuyant sur un vaste réseau mondial de correspondants et d\'experts.',
    ...
    'service7-description': 'Services d\'arbitrage professionnels pour résoudre efficacement les litiges commerciaux et civils entre différentes juridictions.',
    'service9': 'Droit des sociétés',
    'service9-description': 'Services juridiques en droit des sociétés pour la constitution de sociétés, la gouvernance et la conformité.',
    'service3': 'Droit pénal',
    'service3-description': 'Nos services en droit pénal et compliance sont conçus pour offrir un conseil d\'expert et une défense rigoureuse.',
    'service10': 'Droit commercial',
    'service10-description': 'Services juridiques spécialisés pour vos contrats, vos transactions et vos opérations commerciales.',
    'service5': 'Droit fiscal',
    'service5-description': '<strong>DM Legal</strong> vous accompagne pour tout en matière d\'immatriculation TVA, impôt sur les sociétés, conformité fiscale et enjeux fiscaux internationaux.',
    'service6': 'Testaments et Planification Successorale',
    'service6-description': 'Les testaments <strong>DIFC</strong> et <strong>ADGM</strong> offrent un mécanisme sécurisé permettant aux expatriés non musulmans de distribuer leurs actifs conformément à leurs souhaits.',
    ...
    'service2-description': 'Une protection complète pour vos innovations, votre identité de marque, vos marques déposées et vos créations.',
    ...
    'service2-item2': '<strong>Marques :</strong> enregistrement et protection des noms, logos et signes distinctifs des produits ou services.',
    'service2-item3': '<strong>Droits d\'auteur :</strong> protection des œuvres originales telles que les créations artistiques, musicales, littéraires et les logiciels.',
    'service2-item4': '<strong>Secrets d\'affaires :</strong> préservation de la confidentialité des informations et procédés commerciaux sensibles.',
    'service2-item5': '<strong>Application des droits de PI :</strong> actions visant à prévenir les atteintes et les utilisations non autorisées.',
    ...
    'service3-content': 'Chez <strong>DM Legal</strong>, nous sommes spécialisés en droit pénal à portée internationale et proposons des stratégies de défense ainsi que des conseils juridiques de haut niveau dans plusieurs juridictions. Toutes les procédures sont traitées en collaboration avec des avocats locaux représentant les clients devant les juridictions nationales et les tribunaux internationaux (<strong>CEDH</strong>, <strong>CPI La Haye</strong>, Interpol et autres instances supranationales).',
    ...
    'service4-item2': '<strong>Résidence et citoyenneté :</strong> Conseils pour l\'obtention de la résidence permanente ou de la citoyenneté.',
    'service4-item3': '<strong>Permis de travail :</strong> obtention des autorisations légales nécessaires pour exercer une activité professionnelle dans un pays étranger.',
    'service4-item4': '<strong>Conformité en matière d\'immigration :</strong> Garantir le respect des lois sur l\'immigration et éviter les sanctions.',
    'service4-item5': '<strong>Relocalisation temporaire :</strong> Facilitation des séjours de courte durée à des fins professionnelles ou personnelles.',
    ...
    'service7-part5-desc': 'Opérant dans des cadres de Common Law largement dérivés du système juridique anglais, les <strong>tribunaux caribéens et offshore</strong> servent de juridictions clés pour la résolution de litiges internationaux et les affaires corporatives. Ceci inclut les tribunaux des Îles Caïmans, des Îles Vierges britanniques, des Îles Turques et Caïques, de la Grenade, de Trinité-et-Tobago et d\'Antigua-et-Barbuda. Ces juridictions sont largement reconnues pour leur rôle dans le traitement des litiges commerciaux complexes, des structures offshore et des affaires juridiques multi-juridictionnelles.',
    'service7-description': 'L\'équipe de <strong>DM Legal</strong> privilégie les solutions de règlement alternatif des litiges et les règlements à l\'amiable, mais avec des avocats inscrits auprès des tribunaux locaux de common law, l\'équipe est heureuse de représenter ses clients auprès de :',
    ...
    'service8-description': 'Le <strong>droit de la famille</strong> régit les questions juridiques liées à la famille, notamment le mariage, le divorce, la garde des enfants, la pension alimentaire et les successions. Le cadre juridique des EAU est principalement influencé par le droit civil et les principes de la Sharia, avec des dispositions distinctes pour les musulmans et les non-musulmans.',
    'service8-key': 'Principaux domaines du droit de la famille :',
    'service8-item1': '<strong>Procédures de divorce :</strong> Processus légaux pour la dissolution du mariage et la résolution des litiges y afférents.',
    'service8-item2': '<strong>Garde d\'enfants et droit de visite :</strong> Détermination des modalités parentales et des droits de visite.',
    'service8-item3': '<strong>Pension alimentaire et soutien financier :</strong> Établissement du soutien financier pour les conjoints et les personnes à charge.',
    ...
    'service10-item2': '<strong>Vente de marchandises :</strong> Lois régissant l\'achat et la vente de biens et de services.',
    'service10-item3': '<strong>Mandat et représentation :</strong> Relations juridiques dans lesquelles une partie agit pour le compte d\'une autre.',
    'service10-item4': '<strong>Banque et finance :</strong> Réglementations applicables aux institutions et aux transactions financières.',
    ...
    'team1-item2': 'Expert reconnu en matière de produits du crime <strong>(POCA)</strong> et de recouvrement d\'avoirs.',
    'team1-item3': 'Classé parmi les meilleurs dans les guides <strong>Chambers UK Bar</strong> et <strong>Legal 500</strong>.',
    ...
    'member1-bar-admissions': 'Inscrit aux barreaux suivants : Angleterre et Pays de Galles (Avocat et Conseil du Roi) ; Îles Caïmans ; Jamaïque ; Grenade ; Îles Vierges britanniques ; Îles Turques-et-Caïques ; Juridictions des Caraïbes',
    ...
    'badge-white-collar-defense': 'Défense en matière de criminalité en col blanc et contentieux réglementaire',
    'badge-1998-silk': 'King\'s Counsel (KC) 1998',
    ...
    'team2-item2': 'Avocate inscrite auprès du <strong>DIFC</strong>.',
    'team2-item3': 'Avocate inscrite auprès de l\'<strong>ADGM</strong>.',
    'team2-item4': 'Avocate inscrite sur la liste des Conseils de la <strong>Cour Pénale Internationale (la Haye)</strong>.',
    'team2-item5': 'Juridictions françaises (Tribunal de grande instance, Cour d\'appel, Tribunal de commerce, juridictions répressives à Paris et en France).',
    'team2-item6': 'DIAC (Émirats Arabes Unis) - Centre d\'arbitrage international de Dubaï.',
    'team2-item8': 'CCI - Chambre de commerce internationale.',
    'team2-item9': 'Arbitrage et résolution des différends.',
...
ar: {
    ...
    'footer-email': 'البريد الإلكتروني: contact@dmlegal.com',
    ...
    'hero-title1': 'حيثُ يلتقي الفنُّ والقانون',
    'hero-loc': 'رأس الخيمة · الإمارات العربية المتحدة',

    // UAE / About Section
    'uae-title': 'موقعنا',
    'about-uae-heading': 'الإمارات العربية المتحدة',
    'uae-description': 'الإمارات العربية المتحدة دولة اتحادية ذات نظام دستوري تتألف من سبع إمارات، أُسست في الثاني من ديسمبر 1971. تتموضع الإمارات في قلب التقاطع الجغرافي بين الشرق والغرب، وتتمتع باستقرار سياسي واقتصادي راسخ، إذ تحتل المرتبة الخامسة والعشرين عالمياً وفق <strong>تقرير التنافسية العالمية لعام 2019</strong> الصادر عن <strong>المنتدى الاقتصادي العالمي</strong>، مما يجعلها محوراً للتبادل التجاري والعلاقات الاقتصادية الدولية. تتميز الدولة بمناخ التسامح والتعايش، إذ تحتضن أكثر من مائتي جنسية في مختلف القطاعات المهنية والتعليمية والسياحية، وفاءً للرؤية التأسيسية للمغفور له بإذن الله الشيخ زايد بن سلطان آل نهيان، الذي أرسى نموذجاً حضارياً فريداً في التعايش والانسجام الإنساني. في <strong>DM Legal</strong>، نجعل من هذه المبادئ والقيم ركيزةً لعملنا وأساساً للمشورة التي نقدمها لموكلينا.',

    'who-we-are-label': 'نبذة عنّا',
    'about-heading': 'عن <strong>DM Legal</strong>',
    'about-desc': '<strong>DM Legal</strong> شركة محاماة دولية تمتد مكاتبها عبر الولايات المتحدة الأمريكية وأوروبا والشرق الأوسط.<br>في عالم يتسارع فيه الانفتاح والتكامل، نواكب هذا التحول بخبرة دولية موثوقة.<br>يمتلك الشريكان المؤسسان، جوردانا دراي وأندرو ميتشيل (مستشار الملك)، رصيداً واسعاً من الممارسة القانونية الدولية، وسجلاً حافلاً من القضايا المتشعبة عبر الولايات القضائية، مدعوماً بشبكة عالمية متنوعة من المراسلين والخبراء المتخصصين.',
    ...
    'service7-description': 'نقدم خدمات تحكيم متخصصة لتسوية المنازعات التجارية والمدنية بكفاءة وحياد، عبر مختلف الولايات القضائية.',
    'service9': 'قانون الشركات',
    'service9-description': 'خدمات قانونية متكاملة تشمل تأسيس الكيانات التجارية وضبط الحوكمة المؤسسية وضمان الامتثال للأنظمة النافذة.',
    'service3': 'القانون الجنائي',
    'service3-description': 'خدماتنا في القانون الجنائي والامتثال الجنائي مُصممة لتأمين الدفاع الراسخ والمشورة القانونية المتخصصة في كل مرحلة من مراحل الإجراءات.',
    'service10': 'القانون التجاري',
    'service10-description': 'خدمات قانونية شاملة تغطي العقود التجارية والمعاملات والعمليات المؤسسية في مختلف القطاعات.',
    'service5': 'قانون الضرائب',
    'service5-description': 'في <strong>DM Legal</strong> نقدم مشورة قانونية متخصصة في التسجيل الضريبي لضريبة القيمة المضافة وضريبة الشركات، والامتثال الضريبي، والمسائل الضريبية ذات الطابع العابر للحدود.',
    'service6': 'الوصايا والتخطيط للتركات',
    'service6-description': 'توفر وصايا <strong>مركز دبي المالي العالمي</strong> و<strong>هيئة أبوظبي للأسواق المالية</strong> إطاراً قانونياً آمناً يُمكّن المغتربين من غير المسلمين من توزيع أصولهم وفق إرادتهم الحرة.',
    ...
    'service2-description': 'حماية قانونية شاملة لابتكاراتكم وعلاماتكم التجارية وهويتكم المؤسسية وأعمالكم الإبداعية.',
    ...
    'service2-item2': '<strong>العلامات التجارية:</strong> تسجيل العلامات التجارية وأسماء المؤسسات والشعارات والرموز المميزة وحمايتها قانونياً.',
    'service2-item3': '<strong>حقوق المؤلف:</strong> صون الأعمال الإبداعية الأصيلة كالفنون والموسيقى والآداب والبرمجيات.',
    'service2-item4': '<strong>الأسرار التجارية:</strong> ضمان سرية المعلومات الخاصة والعمليات التجارية السرية.',
    'service2-item5': '<strong>إنفاذ حقوق الملكية الفكرية:</strong> اتخاذ الإجراءات القانونية اللازمة للحدّ من أي اعتداء أو استخدام غير مرخَّص.',
    ...
    'service3-content': 'في <strong>DM Legal</strong> نتخصص في القانون الجنائي بأبعاد دولية وننتهج استراتيجيات دفاع مُحكمة ومشورة قانونية متخصصة عبر الولايات القضائية المتعددة. تُتخذ جميع الإجراءات بالتعاون مع محامين محليين متمرسين يمثلون الموكلين أمام المحاكم الوطنية والمحاكم والهيئات الدولية (المحكمة الأوروبية لحقوق الإنسان، والمحكمة الجنائية الدولية في لاهاي، والإنتربول، والهيئات الفوق وطنية الأخرى).',
    ...
    'service4-item2': '<strong>الإقامة والجنسية:</strong> الإرشاد والتوجيه للحصول على الإقامة الدائمة أو اكتساب الجنسية.',
    'service4-item3': '<strong>تصاريح العمل:</strong> استصدار التراخيص القانونية اللازمة لمزاولة العمل في دولة أجنبية.',
    'service4-item4': '<strong>الامتثال لتشريعات الهجرة:</strong> ضمان الالتزام بقوانين الهجرة النافذة وتجنب التبعات القانونية.',
    'service4-item5': '<strong>الإقامة المؤقتة:</strong> تيسير الإقامات قصيرة المدة للأغراض المهنية والشخصية.',
    ...
    'service7-part5-desc': 'تعمل <strong>المحاكم الكاريبية والمحاكم البحرية</strong> ضمن أطر القانون الإنجليزي العام المشتقة إلى حد كبير من النظام القانوني الإنجليزي، وتخدم كولايات قضائية رئيسية لتسوية المنازعات الدولية والشؤون التجارية. ويشمل ذلك محاكم جزر الكايمان، وجزر فيرجن البريطانية، وجزر Turks و Caicos، وغرينادا، وترينيداد وتوباغو، وأنتيغوا وبربودا. تُعرف هذه الولايات القضائية بدورها البارز في التعامل مع المنازعات التجارية المعقدة، والهياكل البحرية، والمسائل القانونية متعددة الولايات القضائية.',
    'service7-description': 'يدعم فريق <strong>DM Legal</strong> دائماً مسالك التسوية البديلة للمنازعات، غير أنه — بوصفه ممارساً مسجلاً في محاكم القانون العام المحلية — يسعده تمثيل موكليه أمام:',
    ...
    'service8-description': 'يُنظّم <strong>قانون الأسرة</strong> المسائل القانونية المتعلقة بالرابطة الأسرية، بما فيها الزواج والطلاق وحضانة الأطفال والنفقة وأحكام الإرث. يستند النظام القانوني في الإمارات إلى القانون المدني ومبادئ الشريعة الإسلامية، مع وجود أحكام مستقلة للمسلمين وأخرى لغير المسلمين.',
    'service8-key': 'المجالات الرئيسية في قانون الأسرة:',
    'service8-item1': '<strong>إجراءات الطلاق:</strong> المسارات القانونية لفسخ عقد الزواج وتسوية المسائل المترتبة عليه.',
    'service8-item2': '<strong>حضانة الأطفال وحق الزيارة:</strong> تحديد ترتيبات الوالدية المشتركة وحقوق رؤية الأبناء.',
    'service8-item3': '<strong>النفقة والدعم المالي:</strong> تقدير الالتزامات المالية تجاه الزوجين والأطراف المعالة.',
    ...
    'service10-item2': '<strong>بيع البضائع والخدمات:</strong> الأحكام القانونية المنظِّمة لعمليات الشراء والبيع.',
    'service10-item3': '<strong>الوكالة التجارية:</strong> العلاقات القانونية التي يتصرف فيها طرف نيابةً عن آخر.',
    'service10-item4': '<strong>المصارف والتمويل:</strong> الأنظمة المنظِّمة للمعاملات المالية والمؤسسات المصرفية.',
    ...
    'team1-item2': 'مرجع رائد في عائدات الجريمة <strong>(POCA)</strong> واسترداد الأصول.',
    'team1-item3': 'مُصنَّف في المراتب الأولى بـ<strong>Chambers UK Bar</strong> و<strong>Legal 500</strong>.',
    ...
    'member1-bar-admissions': 'القبول في النقابات: إنجلترا وويلز (محامٍ ومستشار الملك)؛ جزر كايمان؛ جامايكا؛ غرينادا؛ جزر فيرجن البريطانية؛ جزر تركس وكايكوس؛ الولايات القضائية في الكاريبي',
    ...
    'badge-white-collar-defense': 'الدفاع في الجرائم المالية والتنظيمية',
    'badge-1998-silk': 'مستشار ملكي 1998',
    ...
    'team2-item2': 'ممارس مسجل في <strong>مركز دبي المالي العالمي</strong>.',
    'team2-item3': 'ممارس مسجل في <strong>هيئة أبوظبي للأسواق المالية</strong>.',
    'team2-item4': 'محامٍ مدرج في قائمة المحامين لدى <strong>المحكمة الجنائية الدولية في لاهاي</strong>.',
    'team2-item5': 'المحاكم الفرنسية (محكمة الدرجة الأولى، محكمة الاستئناف، المحكمة التجارية، المحاكم الجنائية في باريس وعبر فرنسا).',
    'team2-item6': 'مركز دبي للتحكيم الدولي (الإمارات).',
    'team2-item8': 'غرفة التجارة الدولية.',
    'team2-item9': 'التحكيم وتسوية المنازعات.',
