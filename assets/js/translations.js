...
const translations = {
  ...
  en: {
    ...
    'service3-description': 'Our criminal law and compliance services in the UAE are designed to provide expert guidance and robust defense. With a deep understanding of the complexities of UAE criminal law and the Justice System, our team of seasoned lawyers ensures comprehensive support throughout every stage of your case.',
    'service3-key': 'Key Areas of Our Criminal Law Services Include:',
    'service3-item1': '<strong>Criminal Defense:</strong> Representing clients in criminal cases to safeguard their rights and ensure a fair trial, including in extradition proceedings, <strong>Interpol Red Notices</strong>, and arrest warrant matters.',
    'service3-item2': '<strong>Criminal Claim:</strong> Assisting victims of criminal offences and guide them throughout the judicial process.',
    'service3-item3': '<strong>Legal Advice:</strong> Providing expert legal opinion regarding criminal matters to help clients understand their options.',
    'service3-item4': '<strong>Case Management:</strong> Offering complete support throughout the legal process, from arrest to trial and sentencing.',
    'service3-item5': '<strong>Appeals:</strong> Representing clients in appellate proceedings before various courts, including the Court of First Instance, Court of Appeal, and the Supreme Court.',
    'service3-item6': '<strong>Compliance:</strong> Ensuring compliance with UAE laws, regulations, and procedures throughout the criminal process.',
    'service3-content': 'At <strong>DM Legal</strong>, we specialize in criminal law, offering expert defense strategies and legal advice in the UAE. All procedures are handled in collaboration with local attorneys representing clients in front of UAE Courts and abroad (<strong>ECHR</strong>, <strong>ICC the Hague</strong>...).',
    ...
    'member1-bar-admissions': 'Bar Admissions: England &amp; Wales (Barrister &amp; King\'s Counsel); Grenada; British Virgin Islands; Turks and Caicos Islands',
  ...
  fr: {
    ...
    // --- Service Page: Criminal Law (criminal-law.html) ---
    'service3-description': 'Nos services en droit pénal et en compliance aux Émirats Arabes Unis sont conçus pour offrir un accompagnement expert et une défense solide à nos clients. Forts d\'une parfaite maîtrise des spécificités du droit pénal et du système judiciaire des EAU, nos avocats expérimentés assurent un suivi complet à chaque étape de votre dossier.',
    'service3-key': 'Principaux domaines de nos services de droit pénal :',
    'service3-item1': '<strong>Défense pénale :</strong> représentation des clients dans le cadre de procédures pénales afin de protéger leurs droits et de garantir un procès équitable, y compris en matière d\'extradition, de <strong>notices rouges d\'Interpol</strong> et de mandats d\'arrêt.',
    'service3-item2': '<strong>Plainte pénale :</strong> accompagnement des victimes d\'infractions pénales et assistance tout au long de la procédure judiciaire.',
    'service3-item3': '<strong>Conseil juridique :</strong> Fournir des avis juridiques experts sur les questions pénales afin d\'aider les clients à comprendre leurs options.',
    'service3-item4': '<strong>Gestion de dossier :</strong> Offrir un soutien complet tout au long du processus juridique, de l\'arrestation au procès et au prononcé de la peine.',
    'service3-item5': '<strong>Appels :</strong> Représentation des clients dans les procédures d\'appel devant diverses juridictions, y compris le Tribunal de Première Instance, la cour d\'Appel et la Cour suprême.',
    'service3-item6': '<strong>Conformité :</strong> Garantir le respect des lois, réglementations et procédures des EAU tout au long du processus pénal.',
    'service3-content': 'Chez <strong>DM Legal</strong>, nous sommes spécialisés en droit pénal et proposons des stratégies de défense ainsi que des conseils juridiques de haut niveau aux Émirats Arabes Unis. Toutes les procédures sont traitées en collaboration avec des avocats locaux représentant les clients devant les juridictions des EAU et à l\'étranger (<strong>CEDH</strong>, <strong>CPI La Haye</strong>...).',
    ...
    'member1-bar-admissions': 'Inscrit aux barreaux suivants : Angleterre et Pays de Galles (Avocat et Conseil du Roi) ; Grenade ; Îles Vierges britanniques ; Îles Turques-et-Caïques',
    ...
    'badge-cross-border-litigation': 'Contentieux transfrontalier',
    'badge-difc-courts': 'Tribunaux du DIFC',
    'badge-adgm-courts': 'Tribunaux de l\'ADGM',
...
ar: {
    ...
    // --- Service Page: Criminal Law (criminal-law.html) ---
    'service3-description': 'تُصمَّم خدماتنا في القانون الجنائي والامتثال الجنائي في الإمارات لتوفير مشورة قانونية متخصصة ودفاع قانوني متين. بفضل الإلمام العميق بتشعبات القانون الجنائي الإماراتي وآليات الجهاز القضائي، يضمن فريقنا من المحامين المحنَّكين تمثيلاً قانونياً شاملاً في كل مرحلة من مراحل الإجراءات.',
    'service3-key': 'المجالات الرئيسية لخدماتنا في القانون الجنائي:',
    'service3-item1': '<strong>الدفاع الجنائي:</strong> تمثيل الموكلين في القضايا الجنائية لصون حقوقهم وكفالة محاكمة عادلة، بما يشمل قضايا التسليم و<strong>نشرات الإنتربول الحمراء</strong> ومذكرات التوقيف.',
    'service3-item2': '<strong>الادعاء الجنائي:</strong> مساندة ضحايا الجرائم وتوجيههم خلال مراحل الملاحقة القضائية.',
    'service3-item3': '<strong>المشورة القانونية الجنائية:</strong> تقديم آراء قانونية متخصصة في المسائل الجنائية لتمكين الموكلين من فهم خياراتهم القانونية بوضوح.',
    'service3-item4': '<strong>إدارة القضايا:</strong> تأمين الدعم القانوني الكامل طوال مراحل الإجراءات من الاعتقال حتى صدور الحكم.',
    'service3-item5': '<strong>الطعون والاستئنافات:</strong> تمثيل الموكلين في مسالك الطعن أمام مختلف درجات التقاضي، بما فيها محاكم الدرجة الأولى ومحاكم الاستئناف والمحاكم العليا.',
    'service3-item6': '<strong>الامتثال الجنائي:</strong> ضمان الالتزام بالقوانين واللوائح والإجراءات المقررة في دولة الإمارات طوال مسار الدعوى الجنائية.',
    'service3-content': 'في <strong>DM Legal</strong> نتخصص في القانون الجنائي وننتهج استراتيجيات دفاع مُحكمة ومشورة قانونية متخصصة في الإمارات. تُتخذ جميع الإجراءات بالتعاون مع محامين محليين متمرسين يمثلون الموكلين أمام محاكم الإمارات وفي الخارج، بما يشمل (<strong>المحكمة الأوروبية لحقوق الإنسان</strong>، و<strong>المحكمة الجنائية الدولية في لاهاي</strong>).',
    ...
    'member1-bar-admissions': 'القبول في النقابات: إنجلترا وويلز (محامٍ ومستشار الملك)؛ غرينادا؛ جزر فيرجن البريطانية؛ جزر تركس وكايكوس',
    ...
    'badge-cross-border-litigation': 'التقاضي العابر للحدود',
    'badge-difc-courts': 'محاكم مركز دبي المالي العالمي',
    'badge-adgm-courts': 'محاكم هيئة أبوظبي للأسواق المالية',
